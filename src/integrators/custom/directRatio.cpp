...
class DirectRatioIntegrator : public SamplingIntegrator {
    ...
    bool preprocess(const Scene *scene, RenderQueue *queue,
        ...
        Log(EInfo, "Running LTC ratio estimate integrator.");
        return true;
    }
    ...
    Spectrum Li(const RayDifferential &r, RadianceQueryRecord &rRec) const {
            ...
            for (size_t i=0; i < m_emitterSamples; ++i) {
                ...
                if (dRec.pdf > 0 && // emitter is NULL when dRec.pdf is zero. 
                    ...
                    if (!valueUnhindered.isZero()) {
                        ...
                        LiWithVisibility += valueUnhindered * brdfVal * weight;
        ...
        for (size_t i=0; i < m_approxBrdfSamples; ++i) {
            ...
            if (approxBrdfPdf > 0) {
                ...
                LiWithVisibility += valueUnhindered * brdfVal / (Float) m_approxBrdfSamples;
        ...
        for (size_t i=0; i < m_uniformSamples; ++i) {
            ...
            if (uniformPdf > 0) {
                ...
                LiWithVisibility += valueUnhindered * brdfVal / (Float) m_uniformSamples;
        ...
        for (size_t i=0; i < m_cosineSamples; ++i) {
            ...
            if (cosinePdf > 0) {
                ...
                LiWithVisibility += valueUnhindered * brdfVal / (Float) m_cosineSamples;
                LiWithoutVisibility += valueUnhindered * brdfValApprox / (Float) m_cosineSamples;
            }
        }
       
        Spectrum LiLtc = m_subIntegrator->Li(ray, rRec);
